  ...
  internal = rec {
    ...
    crates = {
      "aargh64" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "kube";
            packageId = "kube";
            features = [ "runtime" "derive" "ws" "admission" ];
          }
          {
            name = "oci-distribution";
            packageId = "oci-distribution";
      ...
      "dyn-clone" = rec {
        ...
        version = "1.0.5";
        edition = "2018";
        sha256 = "0a6xdx9h74477dy0zxhp8skhqxnhhy56jfypbqzs9mknvhx0zr91";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "hyperx" = rec {
        ...
        version = "1.4.0";
        edition = "2015";
        sha256 = "0k08dp5bw415wp3j3fg5paidn6l4mmy59kn65cz1ql7jq8pyj5sn";
        authors = [
        ...
        resolvedDefaultFeatures = [ "headers" ];
      };
      "ident_case" = rec {
      ...
      "k8s-openapi" = rec {
        ...
        version = "0.15.0";
        edition = "2021";
        sha256 = "17amvgf6p366igs972lx1a72r4qqnimxbb9s9sq02szfzh22rbnj";
        authors = [
        ...
        resolvedDefaultFeatures = [ "api" "default" "http" "percent-encoding" "url" "v1_24" ];
      };
      "kube" = rec {
        crateName = "kube";
        version = "0.73.0";
        edition = "2021";
        sha256 = "0r1azz70bs4l1sis9iwpj4basw5in1rnnsxffnpx2dqx10i1kwb0";
        authors = [
        ...
        resolvedDefaultFeatures = [ "admission" "client" "config" "default" "derive" "kube-client" "kube-derive" "kube-runtime" "openssl-tls" "runtime" "ws" ];
      };
      "kube-client" = rec {
        crateName = "kube-client";
        version = "0.73.0";
        edition = "2021";
        sha256 = "1w480axd41qgxr6d1pj5z8zy1gnq5hk22s36fpf0n3zg7xk4pmdw";
        authors = [
          "clux <sszynrae@gmail.com>"
          "Teo Klestrup Röijezon <teo@nullable.se>"
          "kazk <kazk.dev@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "__non_core" "base64" "bytes" "chrono" "client" "config" "dirs" "either" "futures" "http-body" "hyper" "hyper-openssl" "hyper-timeout" "jsonpatch" "jsonpath_lib" "openssl" "openssl-tls" "pem" "pin-project" "rand" "serde_yaml" "tokio" "tokio-tungstenite" "tokio-util" "tower" "tower-http" "tracing" "ws" ];
      };
      "kube-core" = rec {
        crateName = "kube-core";
        version = "0.73.0";
        edition = "2021";
        sha256 = "1rl1ld4gi65kyh51h5x49xc70xqrdg0gym0an861sx4bj6q6ivqy";
        authors = [
          "clux <sszynrae@gmail.com>"
          "kazk <kazk.dev@gmail.com>"
        ];
      ...
      "kube-derive" = rec {
        ...
        version = "0.73.0";
        edition = "2021";
        sha256 = "1sqk9djdnlfzrdzzd1rllpqj67ly6j1bmrjgqnf256q7ydd674is";
        procMacro = true;
        authors = [
          "clux <sszynrae@gmail.com>"
          "kazk <kazk.dev@gmail.com>"
      ...
      "kube-runtime" = rec {
        ...
        version = "0.73.0";
        edition = "2021";
        sha256 = "1h7h38z7j7457592n4dg4k32marm008q14k3pw5n3waqmsjc5rnc";
        authors = [
          "Teo Klestrup Röijezon <teo@nullable.se>"
          "clux <sszynrae@gmail.com>"
        ];
      ...
      "oci-distribution" = rec {
        crateName = "oci-distribution";
        version = "0.9.2";
        edition = "2021";
        sha256 = "1zlivrgk2jndn3w44arjzfg6vwh2970ma1ypc7i9w8vr7hhnj7q4";
        authors = [
      ...
      "olpc-cjson" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1753jspq3h3k2xqw9jcxxfk6bfyp9slpsm7f4kqvn52hd3z4kjkj";
        authors = [
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__tls" "hyper-rustls" "json" "rustls" "rustls-pemfile" "rustls-tls" "rustls-tls-webpki-roots" "serde_json" "stream" "tokio-rustls" "tokio-util" "webpki-roots" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.16.20";
      ...
      "schemars" = rec {
        ...
        version = "0.8.10";
        edition = "2018";
        sha256 = "1vflhh1gnnjj2r5ishagmbca0myg47jg1afqyg5rabfnldkvfiqq";
        authors = [
      ...
      "schemars_derive" = rec {
        ...
        version = "0.8.10";
        edition = "2018";
        sha256 = "0hv77i07w65f8p4rscvd72kvi92yfmiilrk7jl9dkcrc04dpwkdg";
        procMacro = true;
        authors = [
          "Graham Esau <gesau@hotmail.co.uk>"
        ];
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "fs" "io-util" "libc" "macros" "memchr" "mio" "net" "num_cpus" "once_cell" "rt" "rt-multi-thread" "signal" "signal-hook-registry" "socket2" "sync" "time" "tokio-macros" "winapi" ];
      };
      ...
      "tokio-tungstenite" = rec {
        ...
        version = "0.17.1";
        edition = "2018";
        sha256 = "1bi1z1l8392v20mg24gryw5jrm0166wxa155z138qma958is3k86";
        authors = [
      ...
      "tower" = rec {
        ...
        version = "0.4.12";
        edition = "2018";
        sha256 = "0gkisq1mcfyw2i9aq7d1d4y52x35506v8pfzh9sp7pvammizv2cs";
        authors = [
      ...
      "tower-http" = rec {
        ...
        version = "0.3.3";
        edition = "2018";
        sha256 = "1bnvi2pfff2qhkyvpwzhymf9bvylcaxsp3fl91nhm73hb1njqd3x";
        authors = [
          "Tower Maintainers <team@tower-rs.com>"
        ];
        dependencies = [
        ...
        features = {
          ...
          "full" = [ "add-extension" "auth" "catch-panic" "compression-full" "cors" "decompression-full" "follow-redirect" "fs" "map-request-body" "map-response-body" "metrics" "propagate-header" "redirect" "request-id" "sensitive-headers" "set-header" "set-status" "trace" "util" ];
      ...
      "tungstenite" = rec {
        ...
        version = "0.17.2";
        edition = "2018";
        sha256 = "1x848392ihy5mh098sns0lcmb5rdwkxpmdcfya108mz783m2ssnr";
        authors = [
          "Alexey Galakhov"
          "Daniel Abramov"
        ];
      ...
      "warp" = rec {
        ...
        resolvedDefaultFeatures = [ "tls" "tokio-rustls" ];
      };
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-debug" "impl-default" "knownfolders" "minwinbase" "minwindef" "mswsock" "namedpipeapi" "ntsecapi" "objbase" "processenv" "shlobj" "std" "timezoneapi" "winbase" "winerror" "winnt" "winreg" "winsock2" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
      ...
      "www-authenticate" = rec {
        crateName = "www-authenticate";
        version = "0.4.0";
        edition = "2021";
        sha256 = "1l18fkkmg9kya700yzb7jw41qcxnqsh9n8jb2119i3axa1q1kz82";
        authors = [
